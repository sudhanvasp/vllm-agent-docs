...
export const siteConfig: SiteConfig = {
  name: 'vLLM Agent Docs',
  description:
    'An unofficial, agent-ready migration of a focused subset of vLLM’s documentation.',
  repoUrl: 'https://github.com/sudhanvasp/vllm-agent-docs',
  links: [
